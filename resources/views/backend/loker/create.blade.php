                 ...
                 @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" required id="deskripsi" rows="5" name="deskripsi" placeholder="Deskripsi/Kriteria"></textarea>
                    </div>

                    <div class="form-group">
                        <label for="password">Foto</label>
                        <input type="file" name="foto" required id="foto" class="form-control input-md">
                    </div>
