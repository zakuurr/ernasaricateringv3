          ...
          <div class="row">
            <div class="col-md-12 mb-5 mb-md-0">
                ...
                <div class="p-3 p-lg-5 border">
                    ...
                    <div class="border p-3 mb-3">
                        <h3 class="h6 mb-0"><a class="d-block" data-toggle="collapse" href="#collapsecod" role="button" aria-expanded="false" aria-controls="collapsecod">Cash on Delivery</a></h3>
